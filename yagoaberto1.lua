...
function Update:Window(text,logo,keybind)
    ...
    Main:TweenSize(UDim2.new(0, 500, 0, 250),"Out","Quad",0.4,true)
...
local R = Library:AddTab("Raid","11446957539")
local T = Library:AddTab("Teleporte","11155851001")
local S = Library:AddTab("Shop","6031265976")
local D = Library:AddTab("Frutas","11446965348")
...
H:AddLabel("Script By Yago X")
H:AddLabel("Seja bem vindo ao Yago HUB")

H:AddSeperator("Canal Do Youtube")



H:AddButton("YagoRP",function()
setclipboard("https://youtube.com/@YagoRPyoutube?si=0OPeFsHPaoNmuuFb")
end)

H:AddButton("Entre No Servidor Do DISCORD",function()
setclipboard("https://discord.com/invite/yaheCxVs2z")
end)
...
Main:AddDropdown("Selecione Sua Arma",WeaponList,function(value)
...
FarmMode = "Normal"
Main:AddDropdown("Modo De Farm", ListF,function(value)
    FarmMode = value
end)
...
Main:AddToggle("Pegar tudo Do jogo no Automatico",false,function(value)
       _G.AutoFarm = value
...
Main:AddDropdown("Selecione o Mob",tableMon,function(vu)
    _G.SelectMob = vu
end)
   ...
   Main:AddToggle("Auto Farm Sem Missões ",_G.AutoFarmNearest,function(value)
...
spawn(function()
    ...
    Main:AddLabel("Farmar Baus")
    
Main:AddToggle("Farmar Baus",false,function(value)
 AutoFarmChest = value
...
Main:AddToggle("Farmar Baus da Miragem",false,function(value)
...
Main:AddToggle("Farmar Baus Com Teleport Instantaneo",false,function(vu)
	_G.ChestBypass = vu
end)
...
Main:AddToggle("Parar o Farme de Baus",_G.STP,function(vu)
	Grab_Chest = vu
...
Main:AddToggle("Farmar Baus Em Outros Servidores",_G.AutoFarmChest_Hop,function(value)
...
Main:AddDropdown("Selecionar Modelo De Matar O Katakuri:", ListC,function(value)
    CakeFMode = value
end)
    ...
    Main:AddToggle("Farmar Katakuri No Automatico",_G.AutoDoughtBoss,function(value)
...
spawn(function()
    ...
    Main:AddToggle("Spawnar Katakuri No Automatico",true,function(value)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner",value)
    end)
    
    Main:AddToggle("Matar Katakuri v2", _G.Autodoughking,function(value)
         _G.Autodoughking = value
        StopTween( _G.Autodoughking)
    end)
    
    Main:AddToggle("Matar Katakuri v2 Em Outro servidor", _G.AutodoughkingHop,function(value)
...
local BoSs = Main:AddLabel("Status : Selecionar Boss")
...
elseif World3 then
    ...
    Main:AddDropdown("Selecione Seu Boss",tableBoss,function(value)
        _G.SelectBoss = value
    end)
    
    Main:AddToggle("Matar Boss selecionado",_G.AutoFarmBoss,function(value)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Main:AddToggle("Matar Todos os Boss Spawnados",_G.AutoAllBoss,function(value)
        _G.AutoAllBoss = value
        StopTween(_G.AutoAllBoss)
    end)
    
    Main:AddToggle("Matar os Boss De outros servidores",_G.AutoAllBossHop,function(value)
    ...
    Main:AddSeperator("Configurações")
    
    
Main:AddToggle("Teleporte instantaneo",true,function(Fast)
BypassTP = Fast
end)

    
Main:AddToggle("Juntas todos os mobs em um unico lugar",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
_G.BringMode = "Normal"
Main:AddDropdown("Modelo de Agrupamento", Bring,function(value)
    _G.BringMode = value
end)
spawn(function()
    while wait(.1) do
...
Main:AddToggle("Ativar Haki Do Armamento",true,function(value)
_G.AUTOHAKI = value
end)
spawn(function()
    while wait(.1) do
...
Main:AddToggle("Fast attack 1 lento",true,function(Fast)
...
spawn(function()
    ...
    Main:AddToggle("Fast Attack 2 Mais rapido",_G.FastAttack,function(value)
        _G.FastAttack = value
    end)      
...
Main:AddDropdown("Velocidade Do Fast Attack", AttackList,function(MakoGay)
...
Main:AddToggle("Remoção de Notificação",true,function(Fast)
_G.Remove_trct = Fast
end)
...
Main:AddToggle("Remover Som de atack e Level Up",false,function(Remo)
_G.RemoveHit = Remo
end)
...
Main:AddToggle("Remover contador de dano",false,function(Remo)
...
Main:AddToggle("Deixar a tela completamente preta",false,function(Umm)
...
spawn(function()
    ...
    spawn(function()
      ...
      if _G.WhiteScreen then
        ...
        Main:AddToggle("Deixar a tela completamente Branca",_G.WhiteScreen,function(value)
...
elseif _G.WhiteScreen == false then
    ...
    Main:AddToggle("Deixar os Mobs Invisiveis",_G.inv,function(value)
    _G.inv = value
    ...
    Main:AddSeperator("Configuração De Farm")
    ...
    Main:AddSeperator("Configuração de Maestria")
...
M:AddToggle("Teleport a Ilha Da Miragem",_G.AutoMysticIsland,function(value)
    ...
    M:AddToggle("Andar Com o barco No Automatico",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
...
M:AddToggle("Teleporte ao Vendedor de Fruta da Miragem",_G.TPNPC,function(value)
             _G.Miragenpc = value
...
M:AddToggle("Teleporte para a Ingrenagem",_G.TweenMGear,function(value)
_G.TweenMGear = value
...
spawn(function()
    ...
    M:AddToggle("Pegar Superhuman",_G.AutoSuperhuman,function(value)
        _G.AutoSuperhuman = value
    end)
    ...
    M:AddToggle("Pegar DeathStep",_G.AutoDeathStep,function(value)
    ...
    M:AddToggle("Pegar Sharkman Karate",_G.AutoSharkman,function(value)
    ...
    M:AddToggle("Pegar Electric Claw",_G.AutoElectricClaw,function(value)
    ...
    M:AddToggle("Pegar Dragon Talon",_G.AutoDragonTalon,function(value)
    ...
    M:AddToggle("Pegar GodHuman",_G.Auto_God_Human,function(value)
...
M:AddToggle("Pegar Couro no automatico",_G.Makori_gay,function(value)
_G.Leather = value
...
if World1 or world2 or World3 then    
M:AddToggle("Pegar Sucata no automatico",false,function(value)
Scrap = value
StopTween(Scrap)
end)
...
if World3 then  
M:AddToggle("Pegar Conjured Cocoa No Automatico",false,function(value)
Cocoafarm = value
StopTween(Cocoafarm)
end)
...
if World3 then     
M:AddToggle("Pegar Escamas de Dragão No Automatico",false,function(value)
Dragon_Scale = value
...
if World3 then    
M:AddToggle("Pegar Póvora No Automatico",false,function(value)
Gunpowder = value
StopTween(Gunpowder)
end)
...
if World3 then  
M:AddToggle("Pegar Mini Tusk No automatico",false,function(value)
MiniHee = value
StopTween(MiniHee)
end)
...
spawn(function()
    ...
    M:AddToggle("Farmar Materiais Mudando De Servidor",_G.Makori_gay,function(value)
    _G.StardHop = value
    end)

    M:AddSeperator("Raid Avançada")
    
    M:AddToggle("Raid Phoenix No Automatico",_G.AutoAdvanceDungeon,function(value)
   ...
   M:AddSeperator("Maestria de Frutas")
    
    M:AddToggle("Farmar Maestria De Fruta",_G.AutoFarmFruitMastery,function(value)
    ...
    M:AddToggle("Farmar Maestria De Arma",_G.AutoFarmGunMastery,function(value)
...
function EquipWeaponSword()
    ...
    M:AddSeperator("Pegar Buddy Sword No Automatico")
    
    M:AddToggle("Pegar Buddy Sword No Automatico",_G.AutoBudySword,function(value)
        _G.AutoBudySword = value
        StopTween(_G.AutoBudySword)
    end)
    
    M:AddToggle("Pegar Buddy Sword Em Outro Servidor",_G.AutoBudySwordHop,function(value)
...
M:AddToggle("Pegar Soul Guitar Em Outros Servidores",false,function(value)
  _G.soulGuitarhop = value    
 end)

 M:AddSeperator("Cursed Dual Katana")

M:AddToggle("Pegar Cursed Dual Katana No Automatico",_G.AutoCdk,function(value)
