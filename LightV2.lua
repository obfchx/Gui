...
local SOMEXHUB = Update:AddWindow("LIGHT HUB [Permium]",Enum.KeyCode.RightControl)
local NguyenTien = Library:AddTab("Information","1")
local Main = Library:AddTab("Main","1")
local M = Library:AddTab("Item","1")
local Ss = Library:AddTab("Stats","1")
local RaceV4 = Library:AddTab("Race V4","1")
local A = Library:AddTab("Sea Event","1")
local P = Library:AddTab("PVP","1")
local R = Library:AddTab("Dungeon","1")
local T = Library:AddTab("Teleport","1")
local S = Library:AddTab("Shop","1")
local D = Library:AddTab("Devil Fruit","1")
local Misc = Library:AddTab("Misc","1")
--- Thông Tin
NguyenTien:AddSeperator("Information Developer")
NguyenTien:AddLabel("Owner: Truong Vu (Tiny)")
NguyenTien:AddLabel("Support Code: Obfchx (My Girl Friend)")
...
while wait(.1) do
    if _G.FastAttack then
       ...
       Main:AddToggle("Set Spawn Point",false,function(value)
    _G.Set = value
end)
...
Main:AddToggle("One Click",false,function(value)
       _G.AutoFarm = value
...
if _G.ChestBypass then
    ...
    Main:AddToggle("Spawn Cake Prince",false,function(value)
...
RaceV4:AddButton("Teleport to Clock", function()
        Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
        Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
        wait(.1)
  ...
  RaceV4:AddToggle("Auto Complete Trials",false,function(v)
  _G.AutoQuestRace = v
...
spawn(function()
  ...
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
    ...
    A:AddSeperator(" Sea Beast ")
 
    A:AddToggle('Kill Sea Beast', false, function(value)
    ...
    spawn(function()
        ...
        A:AddToggle('Kill PirateShips', _G.KillGhostShip, function(value)
...
FrozenIsland = A:AddLabel("")

A:AddToggle('Teleport Frozen Dimension [ NEED SPAWN ]', false, function(value)
...
A:AddToggle("Auto Kill Terrorshark",_G.Makori_gay,function(value)
...
A:AddToggle("Auto Kill Shark",_G.Makori_gay,function(value)
_G.bjirShark = value
...
spawn(function()
    ...
    A:AddToggle("Auto Kill Piranha",_G.Makori_gay,function(value)
...
spawn(function()
        while wait() do
            ...
            A:AddToggle('Auto Kill GhostShip', _G.bjirFishBoat, function(value)
...
A:AddToggle('Auto Get Anchor [ Need Material ]', _G.BjirAnchorCuy, function(state)
...
spawn(function()
    ...
    A:AddToggle("Auto Sail To Rough Sea",_G.BiirTrax,function(state)
    if state then
        _G.BiirTrax = true
    else
        _G.BiirTrax = false
...
R:AddToggle("Get Fruit below 1M",false,function(value)
 _G.Autofruit = value
end)
spawn(function()
    while wait(.1) do
